        ...
        body.appendChild(el(`
          <div class="row between" style="padding:0.3rem 0;border-bottom:1px solid var(--border);flex-wrap:wrap;gap:0.35rem;${trained ? 'border-left:4px solid var(--success);padding-left:0.45rem;' : ''}">
            ...
            <div class="row">
              ...
              <button class="btn" data-action="skill-trained" data-id="${esc(catId)}"${trained ? ' style="border:2px solid var(--success);background:var(--success);color:var(--field-bg);font-weight:700;"' : ' style="opacity:0.7;"'}>${trained ? 'Изучен' : 'Не изучен'}</button>
